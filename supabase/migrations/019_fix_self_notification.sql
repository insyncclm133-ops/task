-- ============================================================
-- Fix self-notification in notify_on_task_update:
-- Skip inserting a notification for the user who triggered
-- the change (auth.uid()), so they don't get a realtime
-- toast on top of the mutation success toast.
-- ============================================================
